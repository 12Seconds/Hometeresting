    ...
    OI_Event = function (document, Assets, Preview, Dic, customCam, mainRoom) {
        ...
        // asset Explore div ------------------------------------
        oi.assetExplore = oi.document.getElementById("assetExplore");
        ...
        oi.exploreUpdate = function () {
            ...
            for(var i=0; i<oi.mainRoom.scene.children.length; i++){
                ...
                if (oi.mainRoom.scene.children[i].name !== "") {
                    ...
                    oi.assetExploreArray[i].setAttribute("class", "assetExploreArray");
                   ...
                   // oi.assetExploreArray[i].addEventListener("mouseover", bind(oi, oi.exploreOver), false);
                    ...
                    oi.assetExploreArray[i].innerHTML = oi.mainRoom.scene.children[i].name;
        ...
        oi.IconOver = function () {
            oi.divIcons[0].style.opacity = '0.8';
        }
        oi.IconOut = function () {
            oi.divIcons[0].style.opacity = '1';
        }
        oi.IconDown = function () {
            oi.divIcons[0].style.opacity = '1';
        }
        oi.IconUp = function () {
            oi.divIcons[0].style.opacity = '0.8';
