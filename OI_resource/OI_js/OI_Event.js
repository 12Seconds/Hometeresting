...
<<<<<<< HEAD
        ...
        {     
            if(oi.divSideinfo.style.visibility=='hidden')
            {
                oi.divSideinfo.style.animationName='hudOpenMove';
                oi.divSideinfo.style.animationIterationCount= '1';
                oi.divSideinfo.style.animationDuration= '0.25s';
                oi.divSideinfo.style.animationFillMode= 'forwards';
                oi.divSideinfo.style.animationTimingFunction='cubic-bezier(0.25,0.25,0.75,0.75)';
                oi.divSideinfo.style.animationPlayState='paused';

                oi.divButton.style.animationName='buttonOpenMove';
                oi.divButton.style.animationIterationCount= '1';
                oi.divButton.style.animationDuration= '0.25s';
                oi.divButton.style.animationFillMode= 'forwards';
                oi.divButton.style.animationTimingFunction='cubic-bezier(0.25,0.25,0.75,0.75)';
                oi.divButton.style.animationPlayState='paused';

                // divSideinfo.style.display = 'block';
                oi.divButton.style.animationPlayState='running';
                oi.divSideinfo.style.visibility = 'visible';

                oi.divSideinfo.style.animationPlayState ='running';
            }
            else{

                oi.divSideinfo.style.animationName = 'hudCloseMove';
                oi.divSideinfo.style.animationIterationCount= '1';
                oi.divSideinfo.style.animationDuration= '0.25s';
                oi.divSideinfo.style.animationFillMode= 'forwards';
                oi.divSideinfo.style.animationTimingFunction='cubic-bezier(0.25,0.25,0.75,0.75)';
                oi.divSideinfo.style.animationPlayState='paused';
                oi.divSideinfo.style.animationDrection ='normal';

                oi.divButton.style.animationName='buttonCloseMove';
                oi.divButton.style.animationIterationCount= '1';
                oi.divButton.style.animationDuration= '0.25s';
                oi.divButton.style.animationFillMode= 'forwards';
                oi.divButton.style.animationTimingFunction='cubic-bezier(0.25,0.25,0.75,0.75)';
...
<<<<<<< HEAD
        ...
        oi.homeIconOut = function() { oi.divIconBack.style.opacity='1';}
        oi.homeIconDown = function(){ oi.divIconBack.style.opacity='1';; }
