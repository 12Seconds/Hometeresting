...
( function () {
	...
	THREE.TransformGizmoScale = function () {
		...
		this.handleGizmos = {
			...
			XYZ: [
				[ new THREE.Mesh( new THREE.BoxBufferGeometry( 0.3, 0.3, 0.3 ), new GizmoMaterial( { color: 0xffffff, opacity: 0.25 } ) ) ]
			]
    ...
    THREE.TransformGizmoScale2 = function () {
...
*/
    ...
    THREE.TransformGizmoScale2.prototype = Object.create( THREE.TransformGizmo.prototype );
	THREE.TransformGizmoScale2.prototype.constructor = THREE.TransformGizmoScale2;
    
    THREE.TransformGizmoScale3 = function () {
    ...
    THREE.TransformGizmoScale3.prototype = Object.create( THREE.TransformGizmo.prototype );
	THREE.TransformGizmoScale3.prototype.constructor = THREE.TransformGizmoScale3;
	...
	THREE.TransformControls = function ( camera, domElement ) {
		...
		var _gizmo = {
            ...
            "scale2": new THREE.TransformGizmoScale2(),
            "scale3": new THREE.TransformGizmoScale3()
		};
		...
		this.setMode = function ( mode ) {
            ...
            if ( _mode === "scale2" ) scope.space = "local";
            if ( _mode === "scale3" ) scope.space = "local";
		...
		function onPointerMove( event ) {
			...
			if ( _mode === "translate" ) {
                ...
                // details position
                $("#position_x").val(scope.object.position.x);
                $("#position_y").val(scope.object.position.y);
                $("#position_z").val(scope.object.position.z);
                ...
                // details scale
                $("#scale_x").val(scope.object.scale.x);
                $("#scale_y").val(scope.object.scale.y);
                $("#scale_z").val(scope.object.scale.z);

			} else if ( _mode === "scale2" ) {
            ...
            // scale end
                ...
                // details rotation
                $("#rotation_x").val(scope.object.rotation.x);
                $("#rotation_y").val(scope.object.rotation.y);
                $("#rotation_z").val(scope.object.rotation.z);
